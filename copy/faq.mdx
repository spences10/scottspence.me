...
- I want to know what the work is and how I'll be doing it with my
  team, no BS marketing copy please 🙏.
...
- I have <DateDistance date={`2007-11-15`} /> previous experience as
  an analyst developer for financial organisations.
...
- Please don't call without a previously agreed time slot, I prefer to
  ...
  - I've already tried to answer the most basic questions on this
    page, and I've probably phrased them more clearly here than I will
    on the phone.
...
- Want me to know you have spent more than the three seconds nearly
  all recruiters spend on this page? In your email mention **"Quick
  Start Guides Rock!"** and you will have my attention, gratitude and
  a guaranteed reply. 🙏
...
- I have zero time available to take off of my current role for day
  long interview events.
