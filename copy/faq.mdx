...
<Small>
  Last updated: <DateUpdated date={`2020-03-15`} small={`true`} />
</Small>
...
<Small>These value are updated each time the site is built.</Small>
...
I'll consider roles four tube stops **max** from either London
Victoria, Blackfriars or Elephant & Castle.
